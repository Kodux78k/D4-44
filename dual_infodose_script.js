...
// Remapeia a antiga aba 'revo' para 'chat'
    ...
    /*
     * Archetype icon overrides
     *
     * These icons replace the default inline SVG symbols for specific archetypes
     * when rendering the app cards on the home screen. Each entry maps the
     * archetype name (e.g. `atlas`, `nova`) to a PNG data URI. The PNG
     * assets are sourced from the provided archetypes icon pack. If an
     * archetype is not listed here or the corresponding asset is missing,
     * the code falls back to the existing `svgIcon` implementation.
     */
    const ARCHETYPE_ICON_DATA = {
      atlas: 'data:image/png;base64,',
      nova: 'data:image/png;base64,',
      pulse: 'data:image/png;base64,',
      artemis: 'data:image/png;base64,',
      serena: 'data:image/png;base64,',
      lumine: 'data:image/png;base64,',
      rhea: 'data:image/png;base64,',
      solus: 'data:image/png;base64,'
    };

  /* ===================== Arquétipos: ícones PNG ===================== */
  // Algumas versões do pacote de ícones fornecem esferas coloridas para cada arquétipo.
  // Estes dados base64 foram gerados a partir dos arquivos icon_128.png em
  // archetypes_icons_pack_variants.zip. Quando um app possui o campo `icon` igual
  // a uma das chaves aqui, o ícone será exibido a partir deste mapa em vez do
  // desenho vetorial padrão.  Para arquétipos sem entrada (ex.: vitalis, kaos,
  // genus) a função svgIcon será utilizada como fallback.
  const ARCHETYPE_ICON_DATA_DUPLICATE = {
    atlas: 'data:image/png;base64,',
    nova: 'data:image/png;base64,',
    pulse: 'data:image/png;base64,',
    artemis: 'data:image/png;base64,',
    serena: 'data:image/png;base64,',
    lumine: 'data:image/png;base64,',
    rhea: 'data:image/png;base64,',
    solus: 'data:image/png;base64,',
    aion: 'data:image/png;base64,'
  };
    ...
    function appIconFor(a){
      // Determine the icon name (remove any builtin: prefix)
      const name = String(a.icon || '').replace(/^builtin:/, '');
      // If no icon defined, default to atlas SVG
      if (!name) return svgIcon('atlas');
      // Check if there is a PNG override for this archetype; fall back to SVG if not found
      if (ARCHETYPE_ICON_DATA && Object.prototype.hasOwnProperty.call(ARCHETYPE_ICON_DATA, name)) {
        return ARCHETYPE_ICON_DATA[name];
      }
      // If the name matches a known built-in icon, use the inline SVG
      if (/^(atlas|nova|vitalis|pulse|artemis|serena|kaos|genus|lumine|rhea|solus|aion|local)$/.test(name)) {
        return svgIcon(name);
      }
      // Otherwise return the provided path (external)
      return a.icon;
    }
